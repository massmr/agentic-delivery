...
const HELP_TEXT = [
  ...
  '  ewokbot mcp inspect <server-id> [--schema|--json] [--cache-registry]',
  '  ewokbot runs',
  ...
  '  mcp         Inspect configured MCP server tools, registry metadata, and optional schemas without calling tools.',
