...
1. Milestone AA from `docs/plans/approved-backlog.md` is complete.
2. The next approved product direction remains the npm-installable CLI and VPS runtime path.
3. The next approved implementation milestone is Milestone AB: Doctor And Local Readiness Checks.
...
Next approved work: Milestone AB from `docs/plans/approved-backlog.md`.
...
2. AB - Doctor And Local Readiness Checks. Next approved work.
3. AC - Long-Running Worker Runtime.
